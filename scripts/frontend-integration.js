 ...
 * This file demonstrates how to integrate Mirthprism with a web frontend
 */

// For React/Vue/Angular applications
export class MirthprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MirthprismClient(provider, contractAddress);
